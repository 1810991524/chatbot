 ...
 Reply.prototype.getReply = function(intent){
    if(!intent){
      ...
      switch(intent.name){
        ...
        case "init2": return "The Restaurant ChatBot is here to help you.";
        case "affirm": return "Thank You :)";
